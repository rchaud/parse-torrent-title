...
exports.addDefaults = /** @type Parser */ parser => {
    ...
    parser.addHandler("languages", /\btraditional\W?\b(chinese|chin[eê]s)\b/i, uniqConcat(value("taiwanese")), { skipIfFirst: true, skipIfAlreadyFound: false, remove: true });
    ...
    parser.addHandler("languages", /\bspanish\W?latin|american\W*spa/i, uniqConcat(value("latino")), { skipFromTitle: true, skipIfAlreadyFound: false, remove: true });
    ...
    parser.addHandler("languages", /\bslovenian\b|\bslo(?=[\]_)]?\.\w{2,4}$)/i, uniqConcat(value("slovenian")), { skipFromTitle: true, skipIfAlreadyFound: false });
