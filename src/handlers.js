...
exports.addDefaults = /** @type Parser */ parser => {
    ...
    parser.addHandler("resolution", /(?:BD|HD|M)(720|1080|2160|4320)/, value("$1p"), { remove: true });
    parser.addHandler("resolution", /(480|576|720|1080|2160|4320)[pi]/i, value("$1p"), { remove: true });
    ...
    parser.addHandler("source", /\b(?:DVD?|BD|BR|TS|Tss)?[ .-]*Scr(?:eener)?\b/i, value("SCR"), { remove: true });
    ...
    parser.addHandler("seasons", /\bS(\d{4})/, array(integer));
